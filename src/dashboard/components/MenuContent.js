              ...
              >
                ...
                {item.link ? (
                  <a href={item.link} style={{ 
                    ...
                    />
                    <Box component="span" sx={{ ml: 'auto', fontSize: '1rem', opacity: 0.7 }}>
                      →
                    </Box>
                  </a>
                ) : (
          ...
          {SecondaryListItems.map((item, index) => (
            <ListItem key={index} disablePadding sx={{ display: "block", mb: 0.8 }}>
              <Tooltip title={item.text} placement="right">
                <ListItemButton
                  role="option"
                  aria-selected={selectedIndex === PrimaryListItems.length + index}
                ...
                >
                  <ListItemIcon 
                    sx={{ 
                      minWidth: '36px', 
                      color: selectedIndex === (PrimaryListItems.length + index) ? 'primary.main' : 'text.secondary',
                      '& .MuiSvgIcon-root': {
                        fontSize: '1.2rem'
                      }
                    }}
                  ...
                  <ListItemText 
                    ...
                    primaryTypographyProps={{ 
                      fontSize: '0.875rem',
                      fontWeight: selectedIndex === (PrimaryListItems.length + index) ? '500' : '400',
                      letterSpacing: '0.01em'
                    }}
                  />
                </ListItemButton>
